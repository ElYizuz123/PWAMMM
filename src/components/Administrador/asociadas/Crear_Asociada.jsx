...
const Crear_Asociada = () => {
    ...
    return (
        <div className='h-full'>
            ...
            <div hidden={!cAsociadasIsOpen} className={`absolute top-[10%] left-[25%] z-10 w-6/12 h-4/6 ${cAsociadasIsOpen ? "" : "pointer-events-none"}`}>
                <div className='w-full h-2/6 bg-[#f3e0e0] rounded-3xl border-2 border-[#F70073]'>
