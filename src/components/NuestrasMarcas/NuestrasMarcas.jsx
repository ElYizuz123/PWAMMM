...
const NuestrasMarcas = () => {
    return (
       ...
       <p className='text-white text-center text-7xl mr-10 text-delineado mt-56 '> Nuestras  </p>
       <p className='text-[#f70073] text-center text-8xl ml-96 text-delineado'> Marcas </p>
