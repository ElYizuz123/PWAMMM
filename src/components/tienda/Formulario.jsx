          ...
          <div class=" flex relative z-0 -mt-40  group ml-7  ">
            <input
              ...
              class="block  mt-2  px-0 w-[1650px] text-lg text-[#F70073] bg-transparent
               border-0 border-b-2 border-[#C1D128] appearance-none dark:text-black dark:border-[#C1D128]  dark:focus:border-[#F70073] focus:outline-none focus:ring-0 focus:border-[#F70073] peer"
              placeholder=" "
              required
            />
            <label
        ...
        <form>
          <div>
              ...
              <div class=" grid md:grid-cols-3 md:gap-[62px]">
                <div class="relative flex  z-0 w-full mb-5 ml-7 mt-4 group">
                  <input
                    ...
                    name="floating_calle"
                    id="floating_calle"
                    class="block py-3  px-0 w-[500px]  text-lg text-[#F70073] bg-transparent border-0 border-b-2 
                   border-[#C1D128] appearance-none dark:text-black dark:border-[#C1D128] 
                  dark:focus:border-[#F70073] focus:outline-none focus:ring-0 focus:border-[#F70073] peer"
                    placeholder=" "
                    required
              ...
              <div class=" grid md:grid-cols-4 md:gap-[200px]">
                ...
                <div class="relative z-0 w-full mb-5  mt-4 group">
                  <input
                    ...
                    id="floating_numExt"
                    class="block py-3 mt-4 px-0 w-[250px]  text-lg text-[#F70073] bg-transparent border-0 border-b-2 
                  border-[#C1D128] appearance-none dark:text-black dark:border-[#C1D128] 
                  dark:focus:border-[#F70073] focus:outline-none focus:ring-0 focus:border-[#F70073] peer"
                    placeholder=" "
                    required
                ...
                <div class="relative z-0 w-full mb-5  mt-6 group">
                  <select
                    type="region"
                    class="block py-3 mt-2 px-0 w-[250px] font-semibold text-gray-500 text-lg  bg-transparent border-0 border-b-2
            ...
            <div class="  relative z-0 mt-9  ml-7  ">
              <p className=" w-[1650px]  border-0 border-b-2 border-[#C1D128] font-semibold  text-2xl text-black">
                MÉXICO
              </p>
            </div>
          </div>
