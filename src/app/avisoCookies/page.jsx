...
const page = () => {
	return (
		<div className="bg-slate-100 w-full h-full flex items-center justify-center">
			<div className="w-3/4 bg-white m-8">
				<div className="m-8">
					<Link href="/" className="flex">
						<div className="bg-[#D60064] hover:bg-[#d60064c9] p-2 text-white rounded-lg">
							Regresar al sitio
						</div>
					</Link>
					<h1 className="font-bold">Aviso de Cookies</h1>
					<h1 className="font-bold">¿Qué son las cookies?</h1>
